...
public class SecureLink {
	 ...
	 * @return
	 */
	public static String createDownloadRedirectLink(String link, String fileName, String secret) {
		Map<String, String> parameterMap = new HashMap<String, String>();
		parameterMap.put("link", link);
		parameterMap.put("fileName", fileName);
		String parameter_json = JsonUtils.toJSONString(parameterMap);
	 ...
	 * @return
	 */
	public static String createVideoRedirectLink(String link,String secret){
		Map<String,String> parameterMap = new HashMap<String,String>();
		parameterMap.put("link", link);
		String parameter_json = JsonUtils.toJSONString(parameterMap);
