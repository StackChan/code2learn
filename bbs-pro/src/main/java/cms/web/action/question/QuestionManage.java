...
public class QuestionManage {
	...
	*/
	...
	@Cacheable(value="questionManage_cache_analysisFullFileName",key="#questionId")
	public Map<String,String> query_cache_analysisFullFileName(String html,Long questionId,List<String> baseUrlList){
		return textFilterManage.analysisFullFileName(html,"question",baseUrlList);
	}

	@Cacheable(value="questionManage_cache_markUpdateTopicStatus",key="#questionId")
	public Integer query_cache_markUpdateTopicStatus(Long questionId, Integer randomNumber){
		return randomNumber;
	}
	 ...
	 * @return
	 */
	@Cacheable(value="questionManage_cache_processFullFileName",key="#processFullFileNameId")
