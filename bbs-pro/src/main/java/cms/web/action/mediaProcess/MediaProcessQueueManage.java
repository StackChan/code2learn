...
public class MediaProcessQueueManage {
	...
	@Cacheable(value="mediaProcessQueueManage_cache_processVideoPlayer2",key="#processVideoPlayerId")
	public String query_cache_processVideoPlayer2(String localUrl,String html,String processVideoPlayerId,String secret){

		return textFilterManage.processVideoPlayer(localUrl,html,secret);
	}
	 /**
