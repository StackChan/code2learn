...
<!--                        <el-date-picker v-model="state.start_postTime_format" type="datetime" format="YYYY-MM-DD HH:mm" placeholder="起始时间" ></el-date-picker>-->
<!--                    </el-form-item>-->
<!--                </el-tooltip>-->
<!--                <el-tooltip content="不限制请留空" placement="top">-->
<!--                    <el-form-item :error="error.end_postTime" >-->
<!--                        <el-date-picker v-model="state.end_postTime_format" type="datetime" format="YYYY-MM-DD HH:mm" placeholder="结束时间"></el-date-picker>-->
<!--                    </el-form-item>-->
<!--                </el-tooltip>-->
                <el-form-item >
...
<!--        </div>-->
        <div class="data-table" >
            <el-table ref="multipleTable" :data="state.tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" stripe empty-text="没有内容">
                ...
                <el-table-column prop="viewTime" label="浏览时间" align="center" width="160"></el-table-column>
                <el-table-column prop="sort" label="排序" align="center" width="80"></el-table-column>
                <el-table-column label="操作" align="center" min-width="120">
                    <template #default="scope">
                        <div class="button-group-wrapper">
                            <el-button-group>
                                <el-button type="primary" v-if="verifyPermissionMenu('/control/question/manage?method=view*','get')" @click="store.setCacheNumber();$router.push({path: '/admin/control/question/manage/view', query:{ questionId : scope.row.id,flag: 2}})">查看</el-button>
...
<script lang="ts" setup>
    ...
    const page = (page:number) => {
        ...
        router.push({
            path: '/admin/control/question/history',
            query:{
