...
const routes = [
    {path : '/admin/control/manage/index',component: () => import('@/views/index.vue'),
        children: [//嵌套一级子路由
            ...
            {path : '/admin/control/question/history',component : () => import('@/views/question/questionHistory.vue'), name:'questionHistory',meta: {index:'1-100200-7',title:'自我疗愈浏览记录',cacheNumber:'0'}},//问题搜索
